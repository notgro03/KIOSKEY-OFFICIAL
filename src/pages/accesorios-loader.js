...
export async function loadAccesorios() {
  ...
  try {
    ...
    console.error('Error al cargar marcas de accesorios:', error);
  ...
  brandSelect.addEventListener('change', async (event) => {
    ...
    try {
      ...
      console.error('Error al cargar modelos de accesorios:', error);
  ...
  searchButton.addEventListener('click', async () => {
    ...
    resultsContainer.innerHTML = `
      <div class="results-message">
        ...
        <p>Buscando accesorios compatibles...</p>
      </div>
    `;
    ...
    try {
      ...
      resultsContainer.innerHTML = data
        .map((item) => createResultCard(item, 'Accesorio'))
        .join('');
    } catch (error) {
      console.error('Error al buscar accesorios:', error);
      showMessage(resultsContainer, 'Ocurrió un error al buscar los accesorios.', true);
    }
  });
}
